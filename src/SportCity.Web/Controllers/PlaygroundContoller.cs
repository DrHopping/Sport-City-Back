...
public class PlaygroundController : ControllerBase
{
  ...
  [HttpPost]
  public async Task<IActionResult> CreatePlayground([FromBody] PlaygroundRequest request, CancellationToken cancellationToken = new())
  {
    var playground = await _playgroundService.CreatePlayground(request.Name, request.Description, request.CityId, request.Location);
