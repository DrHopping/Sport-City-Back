...
public class PlayerService : IPlayerService
{
    ...
    public PlayerService(IRepository<Player> playerRepository, IRepository<Category> categoryRepository)
    {
    ...
    public async Task<List<Player>> GetAllPlayers() =>
        await _playerRepository.ListAsync(new PlayerIncludeCategorySpec());
